    ...
    <div class="wraper">
      ...
      <ul class="information">
          <li class="informationli">
              <div class="height">182</div>
              <div class="heightext">身高</div>
         </li>
          <li class="informationli">
              <div class="height">1514</div>
              <div class="heightext">代谢</div>
          </li>
          <li class="informationli">
              <div class="height">58</div>
      ...
      <ul class="information1">
          <li class="information2">
              ...
              <div class="informationli3">不规律</div>
          </li>
          <li class="information2">
              <div class="informationli2">睡眠时长</div>
              <div class="informationli3">12小时/天</div>
          </li>
          <li class="information2">
              <div class="informationli2">入睡时间</div>
              <div class="informationli3">早中晚不一定</div>
          </li>
          <li class="information2">
          ...
          <li class="information2">
              ...
              <div class="informationli3">无神 健忘 没胃口</div>
          </li>
          <li class="information2">
              <div class="informationli2">目标</div>
              <div class="informationli3">健康 体态</div>
          </li>
          <div class="null"></div>
      </ul>
    </div>
